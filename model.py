...
class ExactGPSEModel(gpytorch.models.ExactGP, botorch.models.gpytorch.GPyTorchModel):
    ...
    def __init__(self,train_x: torch.Tensor,train_y: torch.Tensor,lengthscale_constraint=None,lengthscale_hyperprior=None,outputscale_constraint=None,outputscale_hyperprior=None,
                 noise_constraint=None,noise_hyperprior=None,ard_num_dims=None,prior_mean=0):
...
class DerivativeExactGPSEModel(ExactGPSEModel):
    ...
    def __init__(self, D: int, normalize=None, unnormalize=None, N_max=None,lengthscale_constraint=None,lengthscale_hyperprior=None,
                 outputscale_constraint=None, outputscale_hyperprior=None, noise_constraint=None, noise_hyperprior=None, ard_num_dims=None, prior_mean=0.0):
    ...
    def get_L_lower(self):
        ...
        return (
            ...
            #changed to .to_dense() from .evaluate()
            .root.to_dense()
            .detach()
        )
